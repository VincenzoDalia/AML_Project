...
There are several methods to perform UDA, the 3 most important are ADVERSARIAL DA, Aligning in feature space and learning implicit representations. Briefly introduce SOTA methods on UDA. Note that our approach is aligning in feature space with activation shaping  and user defined rules.

\subsection{Domain Adaptation is Hard}
Cite UDA challenges. Cite difficulties of more sophisticated methods: train is more complex/hard, it requires more computational power and so on. Note that we design a simple method to achieve good results with less struggle.

\subsection{Do Content-Specific Paths Exist?}
Expand on the main research question.
%-------------------------------------------------------------------------


%------------------------------------------------------------------------
\section{Related Work}
2 related works that help showing how hard it is to perform UDA (possibly with not so great results..)
Extremely simple OOD via activation shaping (We have a strong referenceon this, this inspired our work. Paper name: Extremely Simple Activation Shaping for Out-of-Distribution Detection. Authors: Andrija Djurisic, Nebojsa Bozanic, Arjun Ashok, Rosanne Liu)
