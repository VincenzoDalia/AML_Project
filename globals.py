...
def update_config(args):
    ...
    for arg_layer in args.layers:
        ...
        if layer_name:
            ...
            print(f"Warning: Layer '{arg_layer}' does not match any resnet18 layer, pls refer to --help")
            print(f"Use the following pattern: LAYER.LEVEL.CONV_NUM, i.e: 2.0.1 for layer2.0.conv1")
